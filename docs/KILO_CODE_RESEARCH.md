# Kilo Code (Code Agent) -- Исследование для MOEX AI Hub

**Дата исследования:** 2026-03-18
**Цель:** Определить возможности, ограничения и интеграционный потенциал Kilo Code для MOEX AI Hub
...
## 4. Рекомендации для MOEX AI Hub

### 4.1 Контент, который AI Hub может предложить пользователям Kilo Code

#### A. Готовые Custom Modes (высокий приоритет)

AI Hub может распространять `.yaml` файлы custom modes:
...
AI Hub может поставлять предконфигурированные MCP серверы:
...
### 4.3 Что AI Hub НЕ может предложить для Kilo Code
