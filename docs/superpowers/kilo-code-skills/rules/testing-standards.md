# Testing Standards -- MOEX Agent Hub

## Описание

Стандарты тестирования для проекта MOEX Agent Hub. Определяют требования к покрытию тестами, структуру тестов и правила для AI-агента при генерации тестового кода. Тесты -- обязательная часть каждого PR.
