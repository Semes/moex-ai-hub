/**
 * MOEX AI Hub — mock data (plain JS, no modules)
...
const news = [
  { id: "n1", title: "MOEX AI Hub — ваш помощник в работе с AI", summary: "Делитесь промптами, скиллами и кейсами использования AI-продуктов Биржи. Лучшие авторы получают признание коллег и бонусы.", date: "2026-03-18", tag: "Новое", url: "library.html" }
];
...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Да, если вы используете инструменты MOEX AI Hub. Все модели развёрнуты локально в air-gapped контуре — данные не передаются за пределы сети Биржи. Тем не менее, не загружайте пароли, токены доступа и персональные данные клиентов."
  },
  {
  ...
  },
  {
    ...
    answer: "Да, но с ограничениями. Используйте только инструменты MOEX AI Hub, которые работают внутри периметра. Не передавайте в AI персональные данные клиентов, пароли и токены доступа. Для работы с чувствительными кодовыми базами настройте .kilocodeignore."
  }
];
