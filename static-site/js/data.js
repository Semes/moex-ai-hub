...
const news = [
  { id: "n1", title: "Обратная связь по AI Hub", summary: "Делитесь обратной связью по использованию AI Hub в сообществах Express — ваши идеи помогут сделать платформу лучше.", date: "2026-03-20", tag: "Новое", url: "#express-moex-ai" }
];
